...
if __name__ == "__main__":
    ...
    '''
    Park_data = Data['alabama']['Birmingham Civil Rights National Monument'][0] #Birmingham Civil Rights National Monument is one of the national park in alabama, you are free to change to another park
    print(Park_data)